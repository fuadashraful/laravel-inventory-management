...
<div class="card-body">
    <div class="row">
        ...
        <div class="col-md-6 offset-md-3"> 
            <form method="POST" action="{{ route('insert_supplier') }}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" name="shop" placeholder="Enter Shop name" required>
            </div>

            <div class="form-group">
                <label for="exampleInputPassword1">Account No</label>
                <input type="text" class="form-control" id="exampleInputPassword1" name="account_number" placeholder="Enter  AC no" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" name="branch_name" placeholder="Enter Branch name" required>
            </div>
